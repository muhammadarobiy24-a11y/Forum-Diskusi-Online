  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none fixed inset-0 overflow-hidden">
        <Orb color="#7c3aed" size={700} top="-10%" left="-15%" opacity={0.25} />
        <Orb color="#3b82f6" size={500} top="30%" left="60%" opacity={0.2} />
        <Orb color="#a855f7" size={400} top="70%" left="10%" opacity={0.18} />
        <Orb color="#6366f1" size={600} top="50%" left="40%" opacity={0.12} />
      </div>
      ...
      <nav className="sticky top-0 z-50 px-4 py-3">
        <GlassCard className="mx-auto flex h-14 max-w-6xl items-center justify-between px-6" style={{ borderRadius: 16 }}>
          <Link href="/" className="flex items-center gap-2.5">
            ...
            <span className="text-sm font-bold tracking-tight text-white/90">Forum Diskusi</span>
          </Link>
          ...
          {/* Mobile */}
          <button
            className="rounded-xl p-2 text-white/60 hover:text-white md:hidden"
            ...
            <div className="flex flex-col gap-2">
              {["Fitur", "Komunitas", "Tentang"].map((l) => (
                <a
                  ...
                  className="rounded-xl px-4 py-2.5 text-sm font-medium text-white/60 hover:bg-white/5 hover:text-white"
                >
                  {l}
                </a>
              ))}
              <div className="mt-2 flex flex-col gap-2">
                <Link href="/login" className="rounded-xl border border-white/10 px-4 py-2.5 text-center text-sm font-medium text-white/60">
                  Masuk
                </Link>
                <Link
                  href="/register"
        ...
        <div className="mx-auto max-w-6xl text-center">
          ...
          <div className="mb-8 inline-flex">
            ...
            >
              ...
              <span className="text-xs font-semibold text-white/70">Platform Diskusi Online Terbaik</span>
            </GlassCard>
          </div>

          {/* Headline */}
          <h1 className="mb-6 text-5xl font-black leading-[1.05] tracking-tight sm:text-6xl lg:text-7xl">
            <span className="text-white/90">Tempat Diskusi</span>
            <br />
            <span
              style={{
          ...
          <p className="mx-auto mb-10 max-w-lg text-base font-medium leading-relaxed text-white/50">
          ...
          <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
            ...
            <Link
              href="/post"
              className="flex items-center gap-2 rounded-2xl px-8 py-3.5 text-sm font-bold text-white/70 transition-all hover:text-white"
              style={{
          ...
          <div className="mt-12 flex items-center justify-center gap-3">
            ...
            <p className="text-sm font-medium text-white/40">
              <span className="font-bold text-white/80">1,000+</span> orang sudah bergabung
            </p>
          </div>
          ...
          <div className="mt-16 flex justify-center">
            <GlassCard className="w-full max-w-2xl overflow-hidden p-0" style={{ borderRadius: 28 }}>
              ...
              <div className="flex items-center justify-between border-b border-white/5 px-6 py-4">
                ...
                <div
                  className="rounded-lg px-4 py-1 text-xs text-white/30"
              ...
              <div className="p-6 text-left">
                ...
                >
                  <span className="flex-1 text-sm text-white/30">Tulis postingan baru...</span>
                  <div
                    className="flex h-8 w-8 items-center justify-center rounded-xl"
                    style={{ background: "linear-gradient(135deg, #7c3aed, #3b82f6)" }}
                  >
          ...
          <div className="grid grid-cols-2 gap-4 lg:grid-cols-4">
            {stats.map((s) => (
              <GlassCard key={s.label} className="flex flex-col items-center p-7 text-center">
                ...
                <span className="mt-1 text-xs font-semibold text-white/40">{s.label}</span>
              </GlassCard>
            ))}
          </div>
        </div>
          ...
          <div className="mb-16 text-center">
            <div className="mb-4 inline-flex">
              <GlassCard className="flex items-center gap-2 px-4 py-2" style={{ borderRadius: 999 }}>
                ...
                <span className="text-xs font-semibold text-white/60">Fitur-fitur unggulan</span>
              </GlassCard>
            </div>
            <h2 className="text-4xl font-black tracking-tight text-white/90 sm:text-5xl">
              Semua yang kamu{" "}
              <span
                style={{
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {features.map((f) => (
              ...
              >
                ...
                <h3 className="mb-2 text-base font-bold text-white/90">{f.title}</h3>
                <p className="text-sm font-medium leading-relaxed text-white/40">{f.desc}</p>
              </GlassCard>
            ))}
          </div>
        </div>
          ...
          <GlassCard className="overflow-hidden p-0">
            <div className="grid items-center lg:grid-cols-2">
              ...
              <div className="p-10 lg:p-14">
                <div className="mb-5 inline-flex">
                  <GlassCard className="flex items-center gap-2 px-4 py-2" style={{ borderRadius: 999 }}>
                    ...
                    <span className="text-xs font-semibold text-white/60">Discord-style Server</span>
                  </GlassCard>
                </div>
                <h2 className="mb-5 text-3xl font-black text-white/90 leading-tight sm:text-4xl">
                  Server & Channel<br />
                  <span
                    style={{
                      background: "linear-gradient(135deg, #a78bfa, #60a5fa)",
              ...
              <div className="border-t border-white/5 p-10 lg:border-l lg:border-t-0">
                ...
                >
                  <p className="mb-3 text-xs font-bold uppercase tracking-widest text-white/30">Text Channels</p>
                  ...
                  >
                    <div className="flex gap-2.5">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-white/40">Halo! Ada yang mau diskusi soal AI? 🤖</p>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className="mb-16 text-center">
            <div className="mb-4 inline-flex">
              <GlassCard className="flex items-center gap-2 px-4 py-2" style={{ borderRadius: 999 }}>
                ...
                <span className="text-xs font-semibold text-white/60">Kata mereka</span>
              </GlassCard>
            </div>
            <h2 className="text-4xl font-black tracking-tight text-white/90 sm:text-5xl">
              Dicintai oleh{" "}
          ...
          <div className="grid gap-5 sm:grid-cols-3">
            {testimonials.map((t) => (
              <GlassCard key={t.name} className="flex flex-col justify-between p-7">
                ...
                <p className="mb-6 flex-1 text-sm font-medium leading-relaxed text-white/50">
                  &ldquo;{t.text}&rdquo;
                </p>
            ...
            <div className="relative">
              <div className="mb-5 inline-flex">
                <GlassCard className="flex items-center gap-2 px-4 py-2" style={{ borderRadius: 999 }}>
                  ...
                  <span className="text-xs font-semibold text-white/60">Gratis selamanya · Tanpa kartu kredit</span>
                </GlassCard>
              </div>
              <h2 className="mb-4 text-4xl font-black text-white/90 sm:text-5xl">
                Siap Bergabung?
              </h2>
              ...
              <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
                ...
                <Link
                  href="/post"
                  className="flex items-center gap-2 rounded-2xl px-8 py-4 text-sm font-bold text-white/60 transition-all hover:text-white"
                  style={{
                    background: "rgba(255,255,255,0.04)",
                    border: "1px solid rgba(255,255,255,0.08)",
                  }}
        ...
        <div className="mx-auto max-w-6xl">
          <GlassCard className="flex flex-col items-center gap-6 p-7 text-center sm:flex-row sm:justify-between sm:text-left" style={{ borderRadius: 20 }}>
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-bold text-white/90">Forum Diskusi Online</p>
                <p className="text-xs text-white/30">Tempat ngobrol yang bermakna</p>
              </div>
            </div>
            ...
            <div className="flex gap-2">
              {["Next.js", "TypeScript", "Supabase"].map((t) => (
                <span
                  key={t}
                  className="rounded-lg px-3 py-1.5 text-xs font-semibold text-white/50"
